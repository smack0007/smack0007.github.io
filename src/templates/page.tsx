              ...
              <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                  ...
                  >
                    Home
                    {(page.url === "index.html" ||
                      page.url.startsWith("blog/")) && <span class="visually-hidden">(current)</span>}
                  </a>
                </li>
                <li class="nav-item">
                  <a
                  ...
                  >
                    About
                    {page.url.endsWith("about.html") && <span class="visually-hidden">(current)</span>}
                  </a>
                </li>
                <li class="nav-item">
                  <a
                  ...
                  >
                    Tags
                    {page.url.startsWith("tags/") && <span class="visually-hidden">(current)</span>}
                  </a>
                </li>
              </ul>
